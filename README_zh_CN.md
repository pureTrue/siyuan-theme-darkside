...
- 🥾**更多功能**：请移步[链滴简介帖](https://ld246.com/article/1745120070974)、[v3.3更新内容]([https://ld246.com/article/1748873423189](https://ld246.com/article/1748873423189))、[v3.4更新内容]([https://ld246.com/article/1752464520022](https://ld246.com/article/1752464520022))。
...
- 进一步整修了js菜单，划分了功能区
- 新增「界面层级」：三段式界面、纯线框界面（之前的黑白调主题）、沉淀式界面；

  - 三段式界面、沉淀式界面均需要搭配「隐藏顶栏」功能，并手动隐藏停靠栏，才能达到最佳显示效果。

- 原「卡片式界面」「直角式界面」划为界面框架，二级菜单内增加适配的混搭元素样式；

  - 主要是新增2种标题前缀图标；

- 新增风格「七彩流苏」，然而部分选项暂停留在想法阶段，仅上线多彩标题、文档树、大纲树

  - 文档数列表线放于「视觉引导」栏

- 主题配色新增配色层级：每个主题均有寡淡、默认、鲜艳三段配色，用户选择更丰富
- 其他内容暂未完善，**不要期待，主题慢更**……
- 以上内容均只有亮色模式做了。
...
- **打字机模式**：仅监控键盘上下移动产生的光标移动，使键入更沉浸；另解决不了单个块长度过长导致的显示错误，对表格、代码块、块嵌入高度进行限制。
- 滚动条消失：~~不优雅~~修复为细长条；
